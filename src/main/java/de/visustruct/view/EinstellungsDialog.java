...
public class EinstellungsDialog extends JDialog {
	...
	public EinstellungsDialog(GUI gui, boolean modal) {
		...
		super(gui, I18n.tr("menu.settings.labelsStruktogramm"), modal);
		...
		radioPanel.setBorder(BorderFactory.createTitledBorder(I18n.tr("dialog.elementText.presetSection")));
		...
		mitte.setBorder(BorderFactory.createEmptyBorder(0, 8, 0, 8));
	...
	static final class SimulationSpeedListRenderer extends JLabel implements ListCellRenderer<Double> {
